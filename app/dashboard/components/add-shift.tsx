...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/app/ui/shadcn/ui/select';
...
export default function AddShift({shifts, assignment, day}: Props) {
  ...
  return (
      ...
      >
          <div className="h-[100px] flex items-center justify-center"> {/* Invisible trigger */}
          {isHovered && (
            <Dialog>
