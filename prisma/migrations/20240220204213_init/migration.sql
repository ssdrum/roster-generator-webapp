...
-- AddForeignKey
ALTER TABLE "assignments" ADD CONSTRAINT "assignments_assignedTo_fkey" FOREIGN KEY ("assignedTo") REFERENCES "employees"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "assignments" ADD CONSTRAINT "assignments_shift_fkey" FOREIGN KEY ("shift") REFERENCES "shifts"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "num_employees_assigned" ADD CONSTRAINT "num_employees_assigned_shift_fkey" FOREIGN KEY ("shift") REFERENCES "shifts"("id") ON DELETE CASCADE ON UPDATE CASCADE;
